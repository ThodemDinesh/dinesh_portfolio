...
// Import your handshake animation with proper typing
import handshakeAnimation from '../assets/Handshake_portfolio.json'
...
const Contact = () => {
  ...
  // Fixed Lottie Handshake Animation with better timing - scaled to 0.75x
  const LottieHandshakeAnimation = () => (
    <motion.div className="text-center py-4">
      ...
      <motion.p 
        className="text-green-300/80 mb-3 max-w-sm mx-auto text-sm"
        initial={{ opacity: 0, y: 15 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 1.0, duration: 0.4 }}
      >
      ...
      <motion.div
        className="inline-flex items-center gap-1.5 bg-green-500/20 px-3 py-1.5 rounded-full border border-green-500/30"
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
        transition={{ delay: 1.2, type: "spring", duration: 0.4 }}
      >
        <CheckCircle className="text-green-400" size={14} />
        <span className="text-green-400 text-xs font-medium">I&apos;ll respond within 24 hours</span>
      </motion.div>
    </motion.div>
  )
  ...
  const contactItems: ContactItem[] = [
    { 
      icon: Mail, 
      label: "Email", 
      value: "thodemdinesh2004@gmail.com", 
      href: "mailto:thodemdinesh2004@gmail.com" 
    },
    { 
      icon: Phone, 
      label: "Phone", 
      value: "+91 85004 66729", 
      href: "tel:+918500466729" 
    },
    { 
      icon: MapPin, 
      label: "Location", 
      value: "Ananthapur, India", 
      href: "#" 
    }
  ]

  return (
    <section id="contact" className="py-15 px-3 sm:px-4 lg:px-6 bg-gray-800">
      {/* Visual Separator */}
      <div className="max-w-5xl mx-auto">
        <div className="border-t border-gray-600/50 mb-16"></div>
      </div>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center text-white mb-4">
            Let&apos;s Build Something <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Amazing</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-3 gap-9">
          ...
          <div className="lg:col-span-2">
            <motion.div
              ...
              animate={inView ? { opacity: 1, x: 0 } : {}}
              transition={{ delay: 0.2, duration: 0.8 }}
              className="bg-gray-800/30 backdrop-blur-sm border border-gray-700 rounded-lg hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/10 p-6"
            >
              ...
              <AnimatePresence>
                {status === 'success' && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, scale: 1 }}
                    exit={{ opacity: 0, scale: 0.8 }}
                    className="mb-6 p-6 bg-gradient-to-r from-green-500/10 to-cyan-500/10 border border-green-500/20 rounded-xl"
                  >
                    <LottieHandshakeAnimation />
                  </motion.div>
                )}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Your Name"
                    className={`w-full px-3 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-300 text-sm ${
                      isSubmitting ? 'opacity-60 cursor-not-allowed' : ''
                    }`}
                    required
                    disabled={isSubmitting}
                ...
                <textarea
                  ...
                  placeholder="Your Message..."
                  rows={5}
                  className={`w-full px-3 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-cyan-500 focus:border-transparent resize-none transition-all duration-300 text-sm ${
                    isSubmitting ? 'opacity-60 cursor-not-allowed' : ''
                  }`}
                  required
                  disabled={isSubmitting}
                ...
                <motion.button
                  type="submit"
                  disabled={isSubmitting}
                  className={`w-full flex items-center justify-center gap-2 px-6 py-3 rounded-full font-semibold transition-all duration-300 relative overflow-hidden text-sm ${
                    isSubmitting 
                      ? 'bg-cyan-600 text-white cursor-not-allowed' 
                      : 'bg-cyan-500 hover:bg-cyan-400 text-black hover:shadow-lg hover:shadow-cyan-500/25'
                  }`}
            ...
            >
              ...
              {contactItems.map(({ icon: Icon, label, value, href }) => (
                <motion.a
                  ...
                  href={href}
                  whileHover={{ scale: 1.02, x: 5 }}
                  className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-700/30 transition-all duration-300 group"
                >
                  <div className="p-2 bg-gray-700/50 border border-gray-600 rounded-lg group-hover:border-cyan-500/50 transition-colors">
            ...
            >
              ...
              <div className="flex gap-3">
                <motion.a
                  ...
                  whileHover={{ scale: 1.2, y: -5 }}
                  whileTap={{ scale: 0.9 }}
                  className="p-3 bg-gray-700/50 text-gray-400 hover:text-gray-300 rounded-lg transition-all duration-300"
                >
                  <Github size={16} />
                </motion.a>
                <motion.a
                  ...
                  whileHover={{ scale: 1.2, y: -5 }}
                  whileTap={{ scale: 0.9 }}
                  className="p-3 bg-gray-700/50 text-gray-400 hover:text-blue-400 rounded-lg transition-all duration-300"
                >
                  <Linkedin size={16} />
                </motion.a>
                <motion.a
                  ...
                  whileHover={{ scale: 1.2, y: -5 }}
                  whileTap={{ scale: 0.9 }}
                  className="p-3 bg-gray-700/50 text-gray-400 hover:text-yellow-400 rounded-lg transition-all duration-300"
                >
                  <SiLeetcode size={16} />
                </motion.a>
              </div>
